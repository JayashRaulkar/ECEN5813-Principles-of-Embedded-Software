 ...
 * to 2037 means that all results fit into 12 bits of resolution and
 * are therefore useful for a 12-bit DAC.
 *
...
/*
 * Computes sine of x, measured in radians, using a Taylor series expansion upto 5 terms
 *
 * Parameters:
 *    x     Expressed in radians * TRIG_SCALE_FACTOR
 *
 * Returns:
 *    sin(x) * TRIG_SCALE_FACTOR
 *
 */
...
/*
 * Brief: calculates the triangle value for x
 *
 * Parameters:
 *    x     Expressed in radians * TRIG_SCALE_FACTOR
 *
 * Returns:
 *    x * TRIANGLE_SCALE_FACTOR with appropriate sign value
 *
 */
...
/*
 * Brief: calculates the Square value for x
 *
 * Parameters:
 *    x     Expressed in radians * TRIG_SCALE_FACTOR
 *
 * Returns:
 *     TRIG_SCALE_FACTOR with appropriate sign value
 *
 */
