...
void test_sin()
{
  ...
  {
	 printf(" \nSINE is working FINE :)\n\r");	//modified this part to print to show sine fucntion is working
  }
}

//function for testing the sine Function implemented with Taylor series upto 5 terms
void test_taylor_sin()
{
  ...
  if (max_err > 2.0 || sum_sq > 12000)
  {
	  printf("Error: Do not proceed. Your TAYLOR sine function needs work\n\r");
  }
  else
  {
	  printf(" TAYLOR SINE is working FINE :)\n\r");	//modified this part to print to show sine fucntion is working
  }
}
