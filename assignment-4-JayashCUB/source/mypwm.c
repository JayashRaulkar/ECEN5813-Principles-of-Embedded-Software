...
/**
 * @file    mypwm.c
 * @brief   This file has functions to initialize the TPM module and
 *  		to control the tricolor led at different brightness level
 *
 *
 ...
 *  none
 */
void LED_control(uint32_t RGB_value)
{
