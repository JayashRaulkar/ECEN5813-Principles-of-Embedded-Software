...
/**
 * @file myuart.c
 * @brief - contains function for uart initialization, its handler and the
 *        glue code that ties UART communication code into the standard C library functions
 *
...
{
	int ret = ERROR;  // set return value to -1
